        ...
        <main className='p-3 max-w-7xl mx-auto'>
            ...
            <form className='flex gap-4 flex-col sm:flex-row justify-center' >
                <div className='max-w-2xl flex flex-col gap-6 py-3'>
                    ...
                    <input type="text" placeholder='Title' className='border p-3 rounded-lg '
                        id='title' maxLength='62' minLength='8' required />
                    ...
                    <div className='flex flex-col sm:flex-row gap-4 flex-wrap'>
                        ...
                        <div className='flex flex-col sm:flex-row gap-4'>
                            <input type="Number" placeholder='PinCode' className='border p-3 rounded-lg '
                                id='title' required />
                            <select className='rounded-lg px-4 py-2' name="" id="">
                ...
                <div className='flex flex-col flex-1 gap-4 py-3'>
                    ...
                    <div className='flex flex-wrap gap-4'>
                        <div className='flex items-center gap-3'>
                            ...
                            <input type="number" name="bedrooms" id="bedrooms" min={'1'} max={'10'}
                                className='py-2 px-4 rounded-lg border' />
                            <p>Bed Rooms</p>
                        </div>
                        <div className='flex items-center gap-3'>
                            <input type="number" name="guests" id="guests" max="2" min='0'
                                className='py-2 px-4 w-24  rounded-lg border' />
                            <p>Guest Rooms</p>
                        </div>
                        <div className='flex items-center gap-3'>
                            <input type="number" name="baths" id="baths" min={'1'} max={'5'}
                                className='py-2 px-5 rounded-lg border' />
                            <p>Baths</p>
                        </div>

                        <div className='flex items-center gap-3'>
                            <input type="number" name="regularprice" id="regularprice" min={'1'} max={'10'}
                                className='py-2 px-4 rounded-lg border' />
                    ...
                    <button className='p-3 bg-slate-800 text-white rounded-lg uppercase hover:opacity-90 disabled:opacity-80'>Create Listing</button>
                </div>
            </form>
        </main >
    )
