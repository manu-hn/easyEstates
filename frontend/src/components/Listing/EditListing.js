    ...
    <main className='p-3 max-w-7xl mx-auto'>
      ...
      <form className='flex gap-4 flex-col sm:flex-row justify-center' >
        ...
        <div className='flex flex-col flex-1 gap-4 py-3'>
          ...
          <button disabled={loading || uploading} onClick={handleSubmit} className='p-3 bg-slate-800 text-white rounded-lg uppercase hover:opacity-90 disabled:opacity-80'>{loading ? "Updating List" : "Update Listing"}</button>
